...
def train_and_val(_settings: dict) -> None:
    ...
    for turb_id in turb_ids:
        ...
        model = MultiOutputRegressor(GradientBoostingRegressor(loss="huber", learning_rate=_settings["lr"], n_estimators=_settings["train_epochs"], verbose=1), n_jobs=_settings["num_workers"])
